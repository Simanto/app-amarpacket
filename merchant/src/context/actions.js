...
export const GET_MERCHANT_PACKETS_SUCCESS = "GET_MERCHANT_PACKETS_SUCCESS";
...
export const DELETE_PACKET_BEGIN = "DELETE_PACKET_BEGIN";
export const DELETE_PACKET_SUCCESS = "DELETE_PACKET_SUCCESS";

export const GET_ASSIGNED_DELIVERIES_BEGIN = "GET_ASSIGNED_DELIVERIES_BEGIN";
export const GET_ASSIGNED_DELIVERIES_SUCCESS = "GET_ASSIGNED_DELIVERIES_SUCCESS";
