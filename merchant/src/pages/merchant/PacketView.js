...
const PacketView = () =>{
    ...
    return(
        ...
        {isLoading ?
            ...
            <div>
                {/* Header */}
                <div className='app-header p-4 d-flex flex-row justify-content-start align-items-center'>
                    <div className="app-header_back pe-3">
                ...
                <Row className="d-flex justify-content-center" >
                    <Col md="9" className="card p-0">
                        {/* card: header */}
                        <div className="card-header p-5 d-flex justify-content-between ">
                            <div className="card-header_details">
                        ...
                        {/* card: body */}
                        <Row className="card-body p-5 d-flex justify-content-between align-items-start">
                            <Col md="3">
                            ...
                            <Col md="4" className="bg-light p-4">
                                ...
                                <div className="d-flex justify-content-between border-bottom mb-3">
                                    <p>VAT 15%</p>
                                    <p className="text-danger">(Tk.{singlePacket.collectionAmount > 0 ? vat : 0})</p>
                                </div>
                                <div className="d-flex justify-content-between">
                                    <h5>Total</h5>
